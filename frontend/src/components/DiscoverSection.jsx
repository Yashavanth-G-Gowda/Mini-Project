    ...
    return (
        <div className='py-5 flex flex-col items-center gap-10'>
            ...
            <div className='w-full flex justify-around px-10'>
                <FooterCard number="32" title="Departments" imgSrc="https://i.pinimg.com/736x/56/2b/7b/562b7b258e226c783cec3e3aa812d2f4.jpg" />
                ...
                <FooterCard number="6000" title="Users" imgSrc="https://uxbooth.com/wp-content/uploads/2022/01/image3.png" />
            </div>
        </div>
    )
}
